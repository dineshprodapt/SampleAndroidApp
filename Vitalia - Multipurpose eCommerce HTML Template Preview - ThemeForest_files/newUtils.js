...
DealPlyUtilsCls.prototype.reportImpression = function () {
	...
	if (this.lockImpression == false && dealplyChosenIframe == "flach") {
		...
		DealPlyInteropInner.sendCommand("DealPly.reportQuickEvent({'topic':'gen_ui_imp','interactionid':dpVariables.interactionId,'product':'"+dealPlySkinObj.name+"'});");
...
DealPlyUtilsCls.prototype.listenToClick = function () {
	...
	dpQuery('.offer_block').click(function (e) {
		...
		var is888Template = function(){
			...
			var templatesThatShouldNotUse888 = ["operaPush.html" ,"SkinedYndxTop.html" , "SkinedYndxBottom.html", "LargeStripLargeOffers.html"];
